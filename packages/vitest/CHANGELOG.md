...
- [#6668](https://github.com/Effect-TS/effect/pull/6668) [`83c7497`](https://github.com/Effect-TS/effect/commit/83c74972f67cd05513897e43892b63ef48fb7cc1) Thanks @tim-smart! - Require Vitest 4.1 or later and read suite state from `TestRunner`, removing the direct `@vitest/runner` import and support for Vitest 3 and 4.0.

### Patch Changes

- [#6843](https://github.com/Effect-TS/effect/pull/6843) [`4a394bd`](https://github.com/Effect-TS/effect/commit/4a394bd2980c357bbadbb1684172189511c33381) Thanks @fubhy! - Ensure `throws` and `throwsAsync` fail when the supplied operation returns or resolves without throwing.
...
- [#6444](https://github.com/Effect-TS/effect/pull/6444) [`eb3ea7a`](https://github.com/Effect-TS/effect/commit/eb3ea7a75ef140e78a939f8f58cb8c176d6be0c9) Thanks @rvaccone! - Preserve chained vitest helpers like `it.describe.each` and `it.skip.each` when accessed through the `it` proxy. Previously the proxy returned bound copies of vitest's functions, which stripped their static helper properties and caused `TypeError: it.describe.each is not a function`.
...
- [#6416](https://github.com/Effect-TS/effect/pull/6416) [`a79f5ec`](https://github.com/Effect-TS/effect/commit/a79f5ec4f2d9c7a4001eed15452c94e35c0ce4c9) Thanks @coyaSONG! - Fix record-form property tests to convert Schema values to FastCheck arbitraries.
...
- [#1559](https://github.com/Effect-TS/effect-smol/pull/1559) [`e6d4a4b`](https://github.com/Effect-TS/effect-smol/commit/e6d4a4b306cc428423a934415c6832d04c086924) Thanks @tim-smart! - Broaden the `vitest` peer dependency range to support both v3 and v4.
...
- [#1442](https://github.com/Effect-TS/effect-smol/pull/1442) [`f0c6ee5`](https://github.com/Effect-TS/effect-smol/commit/f0c6ee50bdf7dbf4cc12a58290f13a94a5a4a245) Thanks @IMax153! - Allow top-level `it.layer` to accept `memoMap`, `timeout`, and `excludeTestServices` options, matching the standalone `layer` export. Nested `it.layer` calls remain restricted to `timeout` only.
