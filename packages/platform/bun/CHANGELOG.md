...
- [#7800](https://github.com/Effect-TS/effect/pull/7800) [`d877605`](https://github.com/Effect-TS/effect/commit/d8776058bac7d9497b8654af1aec14ca80de4411) Thanks @kitlangton! - Report Unix socket addresses from Bun HTTP servers.

- [#8036](https://github.com/Effect-TS/effect/pull/8036) [`66e2bec`](https://github.com/Effect-TS/effect/commit/66e2becda49c22c0bb7e102410e1fdba8c144c17) Thanks @nikhilsnayak! - Preserve mapped errors from Bun readable streams.
...
- [#7564](https://github.com/Effect-TS/effect/pull/7564) [`464d0b3`](https://github.com/Effect-TS/effect/commit/464d0b3e5233d08167da370b9ad0f6c92746497b) Thanks @typedrat! - Load Bun's `RedisClient` lazily in `BunRedis`.
...
- [#8035](https://github.com/Effect-TS/effect/pull/8035) [`6f6bd84`](https://github.com/Effect-TS/effect/commit/6f6bd84fe03fbc0d777e8b518635e039b8a1e445) Thanks @nikhilsnayak! - Preserve configured Bun routes when Effect HTTP handlers are installed or restored.
...
- [#7408](https://github.com/Effect-TS/effect/pull/7408) [`e1fb57f`](https://github.com/Effect-TS/effect/commit/e1fb57ffbf3cef2dd3016bacd26a4166a52618b7) Thanks @phibr0! - Compress outgoing Bun WebSocket messages when per-message deflate is configured and negotiated. Messages
...
- [#7113](https://github.com/Effect-TS/effect/pull/7113) [`b9875ea`](https://github.com/Effect-TS/effect/commit/b9875ea4538087227149db56e6e7e3a05d72b94a) Thanks @fubhy! - Fix Bun HTTP server handler restoration and defer shutdown while serve scopes remain active.

- [#7122](https://github.com/Effect-TS/effect/pull/7122) [`c1a13f3`](https://github.com/Effect-TS/effect/commit/c1a13f3157463b2bdadca41cefb505bd04733636) Thanks @fubhy! - Honor offset and byte-count options in Bun Web File responses.
...
- [#6726](https://github.com/Effect-TS/effect/pull/6726) [`955eb69`](https://github.com/Effect-TS/effect/commit/955eb69b795734b13965e0cb83f6396441b4e413) Thanks @tim-smart! - Construct an empty multipart stream for each bodiless Bun request.
...
- [#2537](https://github.com/Effect-TS/effect-smol/pull/2537) [`6d2c614`](https://github.com/Effect-TS/effect-smol/commit/6d2c614fab3da932afbb52e849c2663cf32d7d57) Thanks @tim-smart! - optimize bun stream reading
