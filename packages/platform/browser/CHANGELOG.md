...
- [#7808](https://github.com/Effect-TS/effect/pull/7808) [`d84f865`](https://github.com/Effect-TS/effect/commit/d84f865a48c9302b17254a500ae88bcc316b802c) Thanks @kitlangton! - Return a typed `PlatformError` from `BrowserCrypto` digest operations when `crypto.subtle` is unavailable, instead of failing with a defect.

- [#7868](https://github.com/Effect-TS/effect/pull/7868) [`6b8128e`](https://github.com/Effect-TS/effect/commit/6b8128e0bdc9d6778ca4dcea7effcfd50a500662) Thanks @kitlangton! - Fix `BrowserKeyValueStore.layerIndexedDb` to report keys containing `Uint8Array` values from `has`.

- [#7866](https://github.com/Effect-TS/effect/pull/7866) [`53eb888`](https://github.com/Effect-TS/effect/commit/53eb88875dace386188435884037e4bc25109c37) Thanks @kitlangton! - Invoke custom `BrowserRuntime.runMain` teardown callbacks when the main effect completes, and remove the `pagehide` listener once the main fiber finishes.

- [#7818](https://github.com/Effect-TS/effect/pull/7818) [`072005e`](https://github.com/Effect-TS/effect/commit/072005e64b75452a2f5413b4a1b56a3690007e5b) Thanks @kitlangton! - Preserve out-of-line primary keys in IndexedDB query results, including secondary-index reads.
...
- [#7736](https://github.com/Effect-TS/effect/pull/7736) [`736c882`](https://github.com/Effect-TS/effect/commit/736c882a45b6278a1a0fc773987aaf69a752ca12) Thanks @kitlangton! - Support text, JSON, and stream readers when the XHR response type is `"arraybuffer"`.
...
- [#7292](https://github.com/Effect-TS/effect/pull/7292) [`b2796f3`](https://github.com/Effect-TS/effect/commit/b2796f35fd2baa4d3f85871e1f81ced70eb62e56) Thanks @tim-smart! - Keep BrowserRuntime main programs running when navigation does not unload the document, while interrupting on non-bfcache pagehide events.
...
- [#7075](https://github.com/Effect-TS/effect/pull/7075) [`2f9016d`](https://github.com/Effect-TS/effect/commit/2f9016d23cdbde159153fd8b03507d03a066966f) Thanks @fubhy! - Fix form data decoding for XMLHttpRequest client responses.
...
- [#6857](https://github.com/Effect-TS/effect/pull/6857) [`79db8e5`](https://github.com/Effect-TS/effect/commit/79db8e5e42b300888401b6487e7628e0a05180ab) Thanks @fubhy! - Fix IndexedDB-backed key-value writes to wait for transaction commit before reporting success.

- [#6852](https://github.com/Effect-TS/effect/pull/6852) [`ef6eca7`](https://github.com/Effect-TS/effect/commit/ef6eca71dcb9abef7c2685d127a89e25fb6f0e62) Thanks @fubhy! - Fix IndexedDB query range, ordering, streaming, and transaction semantics.

- [#6683](https://github.com/Effect-TS/effect/pull/6683) [`5f87bc7`](https://github.com/Effect-TS/effect/commit/5f87bc7a6608f129e2ee4eaa6745c61d920bac53) Thanks @tim-smart! - Fix `BrowserCrypto.randomBytes` for requests larger than the Web Crypto per-call limit.
...
- [#6854](https://github.com/Effect-TS/effect/pull/6854) [`39ed94a`](https://github.com/Effect-TS/effect/commit/39ed94a0751ae060ae8db24eb74865a636acf1cd) Thanks @fubhy! - Abort IndexedDB versionchange transactions when schema migrations fail.
...
- [#2241](https://github.com/Effect-TS/effect-smol/pull/2241) [`c5e54d8`](https://github.com/Effect-TS/effect-smol/commit/c5e54d8e4d4ea0f64d9023793b54dfa83d85eac4) Thanks @tim-smart! - Fix IndexedDB bulk writes so `insertAll` and `upsertAll` resume when used inside `withTransaction`.
...
- [#2110](https://github.com/Effect-TS/effect-smol/pull/2110) [`f862e40`](https://github.com/Effect-TS/effect-smol/commit/f862e40573b6d1c04942799be5ff6f7dbea22ae9) Thanks @tim-smart! - cleanup IndexedDb prototypes
...
- [#2086](https://github.com/Effect-TS/effect-smol/pull/2086) [`979b56b`](https://github.com/Effect-TS/effect-smol/commit/979b56b5c45facc488cc920a83339b87fc51334d) Thanks @tim-smart! - fix idb entries transaction
