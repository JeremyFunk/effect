...
- [#7142](https://github.com/Effect-TS/effect/pull/7142) [`c25b84c`](https://github.com/Effect-TS/effect/commit/c25b84c09bbbb68343e157bda9cd4c42e1e5e515) Thanks @fubhy! - Prevent unhandled `pg` client error events while `PgClient.makeClient` is connecting.
...
- [#6991](https://github.com/Effect-TS/effect/pull/6991) [`4a17049`](https://github.com/Effect-TS/effect/commit/4a17049157d83f55d44a6e8b1c58c28df2ffd65a) Thanks @fubhy! - Hold the shared PostgreSQL client permit for the full transaction lifetime.
...
- [#6451](https://github.com/Effect-TS/effect/pull/6451) [`0e135bd`](https://github.com/Effect-TS/effect/commit/0e135bd2425abf976d38cdb68d011435034b0537) Thanks @steinerl! - Fix `PgClient.makeClient` to connect the underlying `pg.Client` during resource acquisition.
...
- [#2001](https://github.com/Effect-TS/effect-smol/pull/2001) [`0dd1173`](https://github.com/Effect-TS/effect-smol/commit/0dd117340f9a82e4ca946b54c70b4e3b552f1cfb) Thanks @Mats-Dodd! - Guard transaction connection acquisition in `PgClient.fromPool` so acquire failures stay in the `SqlError` channel.
...
- [#1853](https://github.com/Effect-TS/effect-smol/pull/1853) [`fb8d29c`](https://github.com/Effect-TS/effect-smol/commit/fb8d29c21f1b2ba8d13f22acbce02cbb615d5659) Thanks @tim-smart! - clean up sql-pg constructors and layers
...
- [#1835](https://github.com/Effect-TS/effect-smol/pull/1835) [`3a5b0ca`](https://github.com/Effect-TS/effect-smol/commit/3a5b0ca75c12e79e39b476c099b7932d8d226bc3) Thanks @tim-smart! - Use `pg_notify` in `PgClient.notify` so channel and payload are sent through parameters instead of a `NOTIFY` statement string.
...
- [#1834](https://github.com/Effect-TS/effect-smol/pull/1834) [`89ed5d6`](https://github.com/Effect-TS/effect-smol/commit/89ed5d6c1e0d2e909f4f519cd86b31a7a59bf59b) Thanks @tim-smart! - Use a dedicated PostgreSQL client for LISTEN / UNLISTEN subscriptions instead of checking out a pooled connection for the listener lifecycle.
